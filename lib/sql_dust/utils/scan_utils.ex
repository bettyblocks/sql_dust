defmodule SqlDust.ScanUtils do
  ...
  def scan_reserved_words(sql) do
    Regex.scan(~r/\b(?=\.)(\b(distinct|and|or|is|like|rlike|point|bigint|bigserial|bit|bit|varying|boolean|bytea|character|character|varying|date|double|precision|integer|numeric|real|serial|smallint|text|time|with|timezone|timestamp|with|timezone|xml|regexp|in|interval|between|not|null|sounds|soundex|asc|desc|true|false)\b)\b/i, sql)
  end
